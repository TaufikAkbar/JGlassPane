 ...
 * @author echo
 */
public class WipeDownTransitionDialog extends TransitionDialog {

    private static final long serialVersionUID = 1L;

    private WipeDownTransition transition;

    public WipeDownTransitionDialog(Frame parent, boolean modal) {
        super(parent, modal);
