 ...
 * @author echo
 */
public class FadeImageTransitionDialog extends ImageTransitionDialog {

    private static final long serialVersionUID = 1L;

    private FadeImageTransition transition;

    public FadeImageTransitionDialog(Frame parent, boolean modal) {
        super(parent, modal);

        transition = new FadeImageTransition();
