 ...
 */
public class WipeRightImageTransitionDialog extends ImageTransitionDialog {

    private static final long serialVersionUID = 1L;

    private WipeRightImageTransition transition;

    public WipeRightImageTransitionDialog(Frame parent, boolean modal) {
        super(parent, modal);

        transition = new WipeRightImageTransition();
